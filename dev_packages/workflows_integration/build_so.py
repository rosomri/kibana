...
so = {
    ...
    "id": "workflows-execution-overview",
    "references": all_refs,
    "type": "dashboard",
    "typeMigrationVersion": "10.3.0",
}

output = "/Users/omrirosner/elastic/kibana/dev_packages/workflows_integration/elastic_workflows-0.1.0/kibana/dashboard/workflows-execution-overview.json"
